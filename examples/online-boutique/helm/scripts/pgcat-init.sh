...
replace_placeholder "___pg_user___" ${POSTGRES_USER}
replace_placeholder "___pg_password___" ${POSTGRES_PASSWORD}
replace_placeholder "___pgcat_port___" ${PGCAT_PORT}
replace_placeholder "___prom_port___" ${PGCAT_PROM_PORT}
