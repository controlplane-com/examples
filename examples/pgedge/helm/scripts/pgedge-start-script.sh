...
/opt/pgedge/pgedge/pg16/bin/psql $POSTGRES_DB -c "SELECT * FROM spock.node;" -p $NODE_PORT

/opt/pgedge/pgedge/pg16/bin/psql $POSTGRES_DB -p $NODE_PORT -f /scripts/replication.sql
